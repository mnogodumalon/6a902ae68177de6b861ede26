...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["zimmer", "anreisedatum", "abreisedatum", {"row": ["vorname", "nachname"]}, "email", "telefon", "anzahl_personen", "nachricht", "status"],
  defaults: {
  ...
  computed: {
    ...
    '_buchung_gesamtkosten': { op: 'mul', left: { kind: 'dateDiff', from: 'anreisedatum', to: 'abreisedatum', unit: 'days' }, right: { kind: 'applookup', ownKey: 'zimmer', lookupKey: 'preis_pro_nacht' } },
  },
};
