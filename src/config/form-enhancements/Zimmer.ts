// Auto-generated. Per-entity form-enhancements config for "Zimmer".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['zimmernummer', 'zimmertyp', 'preis_pro_nacht', 'max_personen'],
  defaults: {
    'zimmertyp': { kind: 'lookup', key: 'doppelzimmer', label: 'Doppelzimmer' },
  },
  computed: {},
};
